                        ...
                        <div className="bg-white rounded-lg shadow-sm p-12 text-center border border-gray-200">
                            ...
                            <p className="text-gray-600 mb-6">
                                {filter === "todos"
                                    ...
                                    : `Você não tem atrasos ${filter === "validado"
                                        ? "validados"
                                        : filter === "pendente"
                                            ? "pendentes"
                                            : "recusados"
                        ...
                        <div className="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
                            ...
                            <div className="bg-red-500 text-white p-4 rounded-t-lg flex-shrink-0">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-lg font-bold">Comprovante de Atraso</h2>
                                    <button
                                        onClick={() => {
                            ...
                            <div className="p-4 space-y-4 overflow-y-auto flex-1">
                                {/* Status */}
                                <div className="flex items-center justify-between">
                                    <span className="text-gray-600 font-semibold text-sm">Status:</span>
                                    <div
                                        className={`flex items-center gap-1 px-2 py-1 rounded-full border font-semibold text-xs ${getStatusColor(
                                ...
                                <div className="border-t pt-3">
                                    <h3 className="text-gray-600 font-semibold mb-2 text-sm">
                                        Informações do Aluno
                                    </h3>
                                ...
                                <div className="border-t pt-3">
                                    ...
                                    <div className="space-y-1 text-xs">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-gray-800 font-medium text-right max-w-[60%] text-wrap">
                                ...
                                {selectedLateEntry.observacao && (
                                    <div className="border-t pt-3">
                                        <h3 className="text-gray-600 font-semibold mb-1 text-sm">
                                            Observações
                                        </h3>
                            ...
                            {/* Modal Footer */}
                            <div className="bg-gray-50 border-t border-gray-200 p-3 rounded-b-lg flex-shrink-0">
                                <button
                                    onClick={() => {
                                        setShowDetailModal(false);
