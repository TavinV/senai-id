...
const Carteirinha = ({
  ...
  return (
    <>
      ...
      {/* Modal do QR Code - ATUALIZADO */}
      {qrOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm mx-auto">
            {/* Header */}
            <div className="bg-red-500 text-white rounded-t-xl p-6">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold">QR Code de acesso</h3>
                <button
            ...
            <div className="p-6">
              <div className="flex flex-col items-center gap-6">
                {/* QR Code Image */}
                {qrError ? (
                  <p className="text-base sm:text-lg text-red-600">{qrError}</p>
                ) : qrUrl ? (
                ...
                <div className="text-center">
                  <p className="text-gray-700 font-medium text-sm mb-2">
                    Apresente esse código nas catracas do Senai
                  </p>
                </div>
                ...
                <div className="flex gap-3 w-full">
                  <button 
                    onClick={closeQrModal}
                    className="flex-1 px-4 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-semibold"
                  >
                    Fechar
                  </button>
                </div>
